...
-- Add call_log_id column to appointments table for follow-up integration
ALTER TABLE public.appointments ADD COLUMN call_log_id uuid REFERENCES public.call_logs(id);
