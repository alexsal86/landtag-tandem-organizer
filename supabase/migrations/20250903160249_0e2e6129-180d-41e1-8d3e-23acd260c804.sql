...
DROP POLICY IF EXISTS "Users can create snapshots for accessible documents" ON public.knowledge_document_snapshots;
DROP POLICY IF EXISTS "Users can view snapshots for accessible documents" ON public.knowledge_document_snapshots;
