...
-- Add new fields to letters table for DIN 5008 compliance
ALTER TABLE public.letters 
ADD COLUMN sender_information_id UUID REFERENCES public.sender_information(id),
ADD COLUMN information_block_id UUID REFERENCES public.information_blocks(id),
ADD COLUMN recipient_address JSONB DEFAULT '{}',
ADD COLUMN letter_date DATE DEFAULT CURRENT_DATE,
ADD COLUMN subject_line TEXT,
ADD COLUMN reference_number TEXT,
ADD COLUMN attachments_list TEXT[];
