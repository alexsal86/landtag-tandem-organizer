...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE polname = 'time_entries_select_scoped'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE polname = 'time_entries_insert_scoped'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE polname = 'time_entries_update_scoped'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE polname = 'time_entries_delete_scoped'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'storage' AND tablename = 'objects' 
      AND polname = 'Users and admins can read contract docs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'storage' AND tablename = 'objects' 
      AND polname = 'Users and admins can upload contract docs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'storage' AND tablename = 'objects' 
      AND polname = 'Users and admins can update contract docs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'storage' AND tablename = 'objects' 
      AND polname = 'Users and admins can delete contract docs'
  ) THEN
