-- Case items: tenant-wide visibility aligned with task_decisions.visible_to_all

ALTER TABLE public.case_items
  ADD COLUMN IF NOT EXISTS visible_to_all boolean NOT NULL DEFAULT false;

CREATE INDEX IF NOT EXISTS idx_case_items_tenant_visible_to_all
  ON public.case_items (tenant_id, visible_to_all);
