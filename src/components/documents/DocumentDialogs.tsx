...
interface DocumentDialogsProps {
  ...
  editFolderId: string; setEditFolderId: (v: string) => void;
        ...
        <DialogContent className="sm:max-w-[400px]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input type="number" value={props.autoArchiveDays} onChange={e => props.setAutoArchiveDays(parseInt(e.target.value) || 30)} min="1" max="365" />
