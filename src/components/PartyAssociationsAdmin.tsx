  ...
  const loadData = async () => {
    ...
    try {
      const [associationsRes, districtsRes] = await Promise.all([
        supabase.from('party_associations').select('id, name, party_name, party_type, phone, email, website, address_street, address_number, address_postal_code, address_city, full_address, administrative_boundaries, tenant_id').order('name'),
