                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-3 text-sm text-muted-foreground">
                      {collaborators.length} {collaborators.length === 1 ? 'Mitarbeiter' : 'Mitarbeiter'}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 pt-2 border-t">
                    {collaborators.map((collab) => (
                      <div key={collab.id} className="flex items-center justify-between p-2 rounded-md hover:bg-muted/50 transition-colors">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">{collab.profiles?.display_name || 'Unbenannt'}</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Select
