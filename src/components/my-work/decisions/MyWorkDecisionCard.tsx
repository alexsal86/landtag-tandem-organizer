  ...
  return (
    ...
    >
      <CardContent className="p-4">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1fr)_380px] xl:grid-cols-[minmax(0,1fr)_420px]">
          <div>
          ...
          <div className="space-y-4 text-xs text-muted-foreground lg:pl-5 lg:border-l lg:border-border/70" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-2 border-t border-border/60 pt-3">
              ...
              {decision.response_deadline && (
                <Badge variant={new Date(decision.response_deadline) < new Date() ? "destructive" : "secondary"} className="gap-1 w-fit">
