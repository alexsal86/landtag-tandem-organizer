        ...
        <div className="space-y-4 py-2">
          ...
          <div className="flex items-center justify-between rounded-md border p-3">
            <div className="space-y-0.5">
              <Label htmlFor="case-item-is-public" className="font-bold">Öffentlich sichtbar</Label>
              <p className="text-xs text-muted-foreground">Alle Mitglieder des Mandanten dürfen den Vorgang lesen.</p>
            </div>
            <Switch id="case-item-is-public" checked={isPublic} onCheckedChange={setIsPublic} />
          </div>
