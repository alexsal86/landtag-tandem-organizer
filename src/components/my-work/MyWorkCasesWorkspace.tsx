                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button variant="outline" size="sm" className="h-9 shrink-0 gap-1.5" onClick={() => setIsItemArchiveOpen(true)} title="Vorgangsarchiv öffnen">
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" size="sm" className="h-8 gap-1.5" onClick={() => setIsFileArchiveOpen(true)} title="Fallaktenarchiv öffnen">
                        <Archive className="h-4 w-4" />
                        Archiv
                      </Button>
