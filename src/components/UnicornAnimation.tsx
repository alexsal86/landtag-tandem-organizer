...
export function UnicornAnimation({ isVisible, onAnimationComplete }: UnicornAnimationProps) {
  const [shouldRender, setShouldRender] = useState(false);

  useEffect(() => {
    if (isVisible) {
      setShouldRender(true);
      // Hide the animation after 2.5-3 seconds
    ...
    <>
      <style>{`
        ...
        .unicorn-container {
          ...
          width: 200px;
          height: 150px;
          animation: unicornRun 2.8s ease-out forwards;
        }
        
        .unicorn-svg {
          filter: drop-shadow(2px 2px 4px rgba(0, 0, 0, 0.2));
          animation: unicornFade 2.8s ease-out forwards;
        }
      ...
      <div className="fixed inset-0 pointer-events-none z-50 overflow-hidden">
        <div className="unicorn-container">
          ...
          <path
            d="M 45 60 Q 35 45 50 35 Q 40 25 55 20 Q 45 10 60 15 Q 50 5 70 10 Q 60 0 80 5 Q 70 -5 90 0"
            fill="none"
          ...
          />
          <path
            d="M 48 65 Q 38 50 53 40 Q 43 30 58 25 Q 48 15 63 20 Q 53 10 73 15 Q 63 5 83 10 Q 73 0 93 5"
            fill="none"
          ...
          {/* Tail */}
          <path
            d="M 140 95 Q 160 85 170 105 Q 175 120 165 135 Q 155 145 145 130 Q 150 115 145 105"
