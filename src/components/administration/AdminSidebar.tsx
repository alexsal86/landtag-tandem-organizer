...
export const adminMenuItems: AdminMenuItem[] = [
  {
    ...
    children: [
      ...
      { id: "security-cockpit", label: "Security-Cockpit", icon: ShieldAlert, superAdminOnly: true },
      { id: "gdpr", label: "DSGVO-Anfragen", icon: Shield },
  ...
  },
  {
    ...
    icon: Workflow,
    children: [
      { id: "rules", label: "Regel-Builder", icon: Workflow },
      { id: "engine", label: "Workflow-Engine 2.0", icon: Workflow },
