...
export function WidgetHoverControls({
  ...
  return (
    <>
      ...
      <div 
        ref={controlsRef}
        className={`absolute top-0 w-14 bg-background/98 backdrop-blur-sm border-2 border-primary/20 rounded-lg shadow-elegant z-[999] transition-all duration-200 ${
