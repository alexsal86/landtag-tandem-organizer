...
const DIN5008_FIELDS = [
  ...
  { path: ['addressField', 'returnAddressFontSize'], label: 'Rücksendezeile Schriftgröße (pt)', section: 'Adressfeld' },
  { path: ['addressField', 'recipientFontSize'], label: 'Empfängeranschrift Schriftgröße (pt)', section: 'Adressfeld' },
  ...
  { path: ['subject', 'fontSize'], label: 'Betreff Schriftgröße (pt)', section: 'Betreff' },
