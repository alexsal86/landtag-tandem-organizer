  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card><CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2"><CardTitle className="text-sm font-medium">Saldo</CardTitle><Calendar className="h-4 w-4 text-muted-foreground" /></CardHeader><CardContent><div className={`text-2xl font-bold ${data.getBalance() >= 0 ? 'text-palette-green' : 'text-palette-red'}`}>{data.getBalance().toFixed(2)} €</div><p className="text-xs text-muted-foreground">Verbleibendes Budget</p></CardContent></Card>
      </div>
