...
export { useCaseFileDetails, type CaseFileContact, type CaseFileDocument, type CaseFileTask, type CaseFileAppointment, type CaseFileLetter, CONTACT_ROLES } from "./files/hooks/useCaseFileDetails";
