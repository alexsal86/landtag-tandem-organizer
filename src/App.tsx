...
const GlobalSearchCommand = lazyWithRetry(() => import("@/components/GlobalSearchCommand").then(m => ({ default: m.GlobalSearchCommand })));
const GlobalQuickNoteDialog = lazyWithRetry(() => import("@/components/GlobalQuickNoteDialog").then(m => ({ default: m.GlobalQuickNoteDialog })));
const GlobalDaySlipPanel = lazyWithRetry(() => import("@/components/GlobalDaySlipPanel").then(m => ({ default: m.GlobalDaySlipPanel })));
