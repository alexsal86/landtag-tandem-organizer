  ...
  public: {
    Tables: {
      ...
      case_file_participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "case_file_participants_case_file_id_fkey"
            columns: ["case_file_id"]
            isOneToOne: false
            referencedRelation: "case_files"
            referencedColumns: ["id"]
      ...
      event_email_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_email_templates_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      task_decision_comment_reactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_decision_comment_reactions_comment_id_fkey"
            columns: ["comment_id"]
            isOneToOne: false
      ...
      team_announcement_dismissals: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_announcement_dismissals_announcement_id_fkey"
      ...
      team_announcements: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_announcements_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
