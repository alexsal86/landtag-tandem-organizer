    ...
    try {
      const organizationName =
        contact.contact_type === "person" && contact.organization_id
          ? organizations.find((org) => org.id === contact.organization_id)?.name || null
          : null;
      ...
      toast({ title: "Fehler", description: "Kontakt konnte nicht aktualisiert werden.", variant: "destructive" });
    } finally {
      setLoading(false);
    }
  };
          ...
          <main className="flex-1 p-6">
            <div className="max-w-4xl mx-auto">
              ...
              <Card className="bg-card shadow-elegant border-border">
                <CardHeader>
                  <CardTitle className="text-2xl">Kontakt bearbeiten (Büro-Ansicht)</CardTitle>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex items-center gap-4">
                      <Avatar className="h-20 w-20">
                        ...
                        <AvatarFallback className="bg-primary text-primary-foreground text-xl">{getInitials(contact.name || "U")}</AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <Input id="role" value={contact.role || ""} onChange={(e) => setContact({ ...contact, role: e.target.value })} />
                        </div>
                        {contact.contact_type === "person" && (
                          <div>
                            ...
                            <Select
                              ...
                              onValueChange={(value) => setContact({ ...contact, organization_id: value === "none" ? "" : value })}
                            >
                              <SelectTrigger>
                        ...
                        {contact.contact_type === "organization" && (
                          <>
                            <div>
                              ...
                              <Input id="industry" value={contact.industry || ""} onChange={(e) => setContact({ ...contact, industry: e.target.value })} />
                            </div>
                            <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input id="website" value={contact.website || ""} onChange={(e) => setContact({ ...contact, website: e.target.value })} />
                        </div>
                        <div>
                          <Label htmlFor="address">Adresse</Label>
                          <Input id="address" value={contact.address || ""} onChange={(e) => setContact({ ...contact, address: e.target.value })} />
                        </div>
                        <div>
                          <Label htmlFor="category">Kategorie</Label>
                          <Select value={contact.category} onValueChange={(value: any) => setContact({ ...contact, category: value })}>
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div>
                          ...
                          <Select value={contact.priority} onValueChange={(value: any) => setContact({ ...contact, priority: value })}>
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div>
                      ...
                      <Textarea id="notes" rows={4} value={contact.notes || ""} onChange={(e) => setContact({ ...contact, notes: e.target.value })} />
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button type="button" variant="outline" onClick={() => navigate(`/contacts/${contact.id}`)}>
                        Abbrechen
                      </Button>
                    </div>
                  </form>
