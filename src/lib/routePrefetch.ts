...
const prefetchMap: Record<string, ImportFn> = {
  dashboard: () => import("@/features/dashboard/components/CustomizableDashboard"),
  mywork: () => import("@/features/dashboard/components/MyWorkView"),
  calendar: () => import("@/features/calendar/components/CalendarView"),
  contacts: () => import("@/features/contacts/components/ContactsView"),
  tasks: () => import("@/features/tasks/components/TasksView"),
  decisions: () => import("@/components/task-decisions/DecisionOverview"),
  meetings: () => import("@/features/meetings"),
  documents: () => import("@/features/documents/components/DocumentsView"),
  knowledge: () => import("@/features/knowledge"),
  settings: () => import("@/components/admin/SettingsView"),
  employee: () => import("@/features/employees"),
  time: () => import("@/features/timetracking"),
  eventplanning: () => import("@/features/event-planning/components/EventPlanningView"),
  casefiles: () => import("@/features/casefiles/components/CaseFilesView"),
  daten: () => import("@/components/admin/DataView"),
